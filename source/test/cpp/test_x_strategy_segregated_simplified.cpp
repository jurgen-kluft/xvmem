...
UNITTEST_SUITE_BEGIN(strategy_segregated2)
{
    UNITTEST_FIXTURE(main)
    {
        ...
        UNITTEST_TEST(init)
        {
            ...
            xsegregatedstrat2::xinstance_t* inst     = xsegregatedstrat2::create(gTestAllocator, mem_base, sMemoryRange);
            xsegregatedstrat2::destroy(inst);
        }
        ...
        UNITTEST_TEST(alloc_dealloc)
        {
            ...
            void* p1 = xsegregatedstrat2::allocate(inst, sMinumSize, 1024);
            xsegregatedstrat2::deallocate(inst, p1);
