...
namespace xcore
{
    ...
    public:
        ...
        xsegregated::xinstance_t* m_segregated;
    };
    ...
    {
        m_segregated = xsegregated::create(main_alloc, node_alloc, vmem_address, vmem_space, level_range, allocsize_min, allocsize_max, allocsize_step, pagesize);
    }

    void* xvmem_allocator_segregated::allocate(u32 size, u32 alignment)
    {
        void* ptr = xsegregated::allocate(m_segregated, size, alignment);
        return ptr;
    }

    void xvmem_allocator_segregated::deallocate(void* ptr) { xsegregated::deallocate(m_segregated, ptr); }
    void xvmem_allocator_segregated::release() { xsegregated::destroy(m_segregated); }
